#!/bin/bash
# Startup script for FramePack in Docker environment using system Python
...
# Find the Python interpreter - first try python (which should point to python3 in the container)
